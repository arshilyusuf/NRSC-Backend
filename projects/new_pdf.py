...
def process_new_pdf(pdf_path, project_id):
    file_name = os.path.basename(pdf_path)
    full_text = extract_text_from_pdf(pdf_path)

    prompt = f"""
You are a helpful assistant. Extract and return only a JSON object with the following fields:
{{ "filename": "{file_name}", "Project Title": "", "Student Name": "", "College Name": "", "Professor Name": "", "Technical Domain": "", "Application Domain": "", "Abstract": "" }}
...
application domains = ["Agriculture", "Disaster Management Support", "Forestry & Ecology", "Geosciences", "LULC", "Rural Development", "Soils", "Urban & Infrastructure", "Water Resources", "Earth and Climatic Studies", "Miscelleaneous"]

technical domains = ["Remote Sensing and GIS", "App Development", "Web Development", "AI/ML", "Image Processing/Computer Vision", "Data Science / Big Data Analytics", "Cloud Computing / High Performance Computing", "IoT", "Sensor Integration", "Drone Data Processing and Integration", "AR/VR", "Robotics", "Embedded Systems", "3D Printing / Fabrication Technology"]
"""
    ...
    try:
        ...
        if os.path.exists("structured_project_data.json"):
        ...
        result["project_id"] = project_id  # Attach project_id to parsed_data too
        ...
        df.to_csv("structured_project_data.csv", mode='a', index=False, header=not os.path.exists("structured_project_data.csv"))
